...
- (NSURL *)logoutRequestURL {
    return _configuration.logoutEndpoint;
}
...
/*! @brief Constructs the request body data by combining the request parameters using the
 ...
 @see https://tools.ietf.org/html/rfc6749#section-4.1.3
 */
- (OIDURLQueryComponent *)logoutRequestBody {
...
- (NSURLRequest *)URLRequest {
    ...
    NSURL *logoutRequestURL = [self logoutRequestURL];
    NSMutableURLRequest *URLRequest = [[NSURLRequest requestWithURL:logoutRequestURL] mutableCopy];
    ...
    OIDURLQueryComponent *bodyParameters = [self logoutRequestBody];
